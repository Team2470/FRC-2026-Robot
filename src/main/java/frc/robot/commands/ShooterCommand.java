...
public class ShooterCommand extends Command{
    ...
    @Override
    public void execute(){
        double TargetRPM = shooter.getHubRPM(Units.inchesToMeters(50));
        double TargetHoodAngle = shooter.getHoodHub(Units.inchesToMeters(50));
        ...
        //                         Math.min(shooterConstants.MAX_HUB_DISTANCE, distance));
