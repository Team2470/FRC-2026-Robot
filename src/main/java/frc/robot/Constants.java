...
public class Constants {
    ...
    public static boolean isBlueAlliance() {
        ...
        // public static Translation2d HUB_LOCATION = BLUE_HUB_LOCATION;
        public static Translation2d HUB_LOCATION = RED_HUB_LOCATION;
        ...
        // public static Translation2d LEFT_PASS_LOCATION = BLUE_LEFT_PASS_LOCATION;
        public static Translation2d LEFT_PASS_LOCATION = RED_LEFT_PASS_LOCATION;
        ...
        // public static Translation2d RIGHT_PASS_LOCATION = BLUE_RIGHT_PASS_LOCATION;
        public static Translation2d RIGHT_PASS_LOCATION = RED_RIGHT_PASS_LOCATION;
    ...
    public static class QuestNavConstants{
        ...
        0.03, // X: Trust Quest to within 3cm (Trust more than odometry)
          ...
          0.1 // Theta: Trust Quest rotation LESS than Gyro (Trust Pigeon more)
        );
    }
    public static class shooterConstants {
        ...
        public static InterpolatingDoubleTreeMap HUB_TOF_MAP    = new InterpolatingDoubleTreeMap();
         ...
         static {
            ...
            PASS_RPM_MAP.put(12.6492, 4000.0);
            PASS_RPM_MAP.put(15.500, 5000.0); // Approximate, not tested, added to pass across field
            PASS_RPM_MAP.put(18.000, 5500.0); // Approximate, not tested, added to pass across field
